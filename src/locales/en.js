const LOCALE = {
  ...
  viz: {
    ...
    shaping: {
      ...
      tunedModelLabel: "Instruction-Tuned",
      raterSummaryIntro: "Your choices shaped a personality:",
      raterSummaryText: (prefs) => `You preferred: ${prefs}. Multiply your preferences by thousands of raters, and you get RLHF \u2014 the model\u2019s personality emerges from the aggregate of these small choices.`,
      raterComparisonOf: (n, total) => `Comparison ${n} of ${total}`,
    },
    digitalFootprints: {
      ariaLabel: "Digital footprints environmental impact visualization",
      energy: {
        chips: [
          { label: "AI query", value: "~0.01 kWh" },
          { label: "Web search", value: "~0.001 kWh" },
          { label: "Model training", value: "~1,300 MWh" },
        ],
        caption: "A single AI query uses roughly 10\u00d7 the energy of a web search. Training scales to hundreds of homes for a year.",
        canvasItems: [
          { label: "AI query", value: 10, unit: "Wh" },
          { label: "Web search", value: 1, unit: "Wh" },
          { label: "Model training", value: 1300000, unit: "kWh", scale: true },
        ],
        scaleNote: "\u2248 100 homes for a year",
        multiplierLabel: "10\u00d7",
        trainingValue: "1,300 MWh",
        sr: "Energy meter compares AI query consumption to web searches and model training costs.",
      },
      carbon: {
        chips: [
          { label: "Training emissions", value: "~552 t CO\u2082" },
          { label: "Equiv. flights", value: "~5 transatlantic" },
          { label: "Equiv. households", value: "~60 years" },
        ],
        caption: "As compute doubles, emissions follow. Carbon cost compounds with each generation of models.",
        canvasItems: [
          { label: "Training", value: 552 },
          { label: "Inference/yr", value: 180 },
          { label: "Hardware", value: 85 },
        ],
        axis: "CO\u2082 equivalent (tonnes)",
        sr: "Carbon emissions from training, inference, and hardware manufacturing shown in tonnes of CO2.",
      },
      resources: {
        chips: [
          { label: "Water cooling", value: "~700K liters/day" },
          { label: "GPU lifespan", value: "~3\u20135 years" },
          { label: "E-waste growth", value: "~15%/year" },
        ],
        caption: "Data centers consume water like small towns. Rapid GPU obsolescence feeds a growing e-waste stream.",
        canvasItems: [
          { label: "Water use", value: 0.85 },
          { label: "GPU lifecycle", value: 0.65 },
          { label: "E-waste", value: 0.72 },
          { label: "Rare minerals", value: 0.58 },
        ],
        axis: "Relative environmental impact",
        sr: "Resource map showing water consumption, GPU lifecycle, e-waste, and rare mineral impacts.",
      },
      sustain: {
        strategies: [
          { title: "Energy", items: ["renewable sources", "grid optimization", "heat reuse"] },
          { title: "Efficiency", items: ["model pruning", "sparse architectures", "distillation"] },
          { title: "Cooling", items: ["liquid cooling", "free-air systems", "waste heat capture"] },
        ],
        caption: "Sustainability is not optional. It requires action at every layer of the stack.",
        sr: "Sustainability dashboard comparing green AI strategies: renewable energy, efficiency, and cooling.",
      },
    },
    nearZeroCost: {
      ariaLabel: "Near-zero cost impact visualization",
      cost: {
        chips: [
          "Legacy marginal cost: ~$1.20/unit",
          "AI marginal cost: ~$0.02/unit",
        ],
        caption: "As marginal cost collapses, the value shifts from production to curation and trust.",
        physicalGoods: "Physical goods",
        aiOutputs: "AI outputs",
        sr: "Cost curves show AI marginal cost collapsing toward zero.",
      },
      flood: {
        counters: [
          { label: "Text outputs", key: "text" },
          { label: "Images generated", key: "images" },
          { label: "Code snippets", key: "code" },
        ],
        caption: "Volume scales faster than verification. The average becomes the default.",
        canvasLabels: ["Text", "Images", "Code"],
        sr: "Content flood metrics climb for text, images, and code outputs.",
      },
      risk: {
        items: [
        ...
        caption: "Risks scale with volume, not intent.",
        sr: "Risk dashboard highlights misinformation, deskilling, security flaws, and economic shock.",
      },
      timeline: {
        items: [
          { year: "1440", label: "Printing Press", full: "1440 Printing Press: ideas replicate faster than scribes" },
          { year: "1760", label: "Industrial", full: "1760 Industrial Revolution: labor scales with machines" },
          { year: "1995", label: "Internet", full: "1995 Internet Era: distribution outruns gatekeepers" },
          { year: "2023", label: "AI Models", full: "2023 AI Models: cognition scales at digital speed" },
        ],
        caption: "Each shift compresses time. This one compresses thought.",
        sr: "Timeline compares historical technology shifts leading to the AI era.",
      },
      strategy: {
        strategies: [
          { title: "Individuals", items: ["upskill", "tool fluency", "domain depth"] },
          { title: "Society", items: ["education reform", "labor transition", "public literacy"] },
          { title: "Policy", items: ["AI Act", "safety audits", "IP frameworks"] },
        ],
        caption: "Preparation is multi-scale. The terrain keeps shifting.",
        sr: "Strategy landscape shows individual, societal, and policy responses.",
      },
    },
    automationCognition: {
      ariaLabel: "Automation of cognition visualization",
      migration: {
        chips: [
          { label: "Data analysis", value: "High exposure" },
          { label: "Content generation", value: "High exposure" },
          { label: "Legal research", value: "Moderate" },
        ],
        caption: "White-collar cognitive tasks are migrating to AI systems. The shift targets reasoning and synthesis, not just routine.",
        canvasRoles: [
        ...
        canvasHuman: "HUMAN",
        canvasAI: "AI",
        sr: "Task migration flow shows cognitive tasks shifting from human workers to AI, with white-collar professions highlighted.",
      },
      productivity: {
        chips: [
          { label: "Productivity gain", value: "+40% avg." },
          { label: "Displacement risk", value: "~30% of roles" },
          { label: "Cognitive dependence", value: "Rising" },
        ],
        caption: "Productivity rises as cognitive load shifts to machines\u2014but over-reliance risks atrophying human problem-solving.",
        canvasItems: [
        ...
        legendProd: "Productivity",
        legendDisp: "Displacement",
        sr: "Productivity versus displacement chart compares AI gains in reasoning, synthesis, and routine tasks against job displacement risk.",
      },
      wealth: {
        chips: [
          { label: "Predistribution", value: "Equity at source" },
          { label: "Redistribution", value: "Correction after" },
          { label: "Concentration risk", value: "Accelerating" },
        ],
        caption: "AI benefits concentrate unless policy intervenes. The question is whether to prevent inequality or correct it.",
        preAILabel: "Pre-AI",
        postAILabel: "Post-AI",
        axisLabel: "Population \u2192 Wealth",
        sr: "Wealth distribution curves shift as AI benefits concentrate, contrasting pre-AI and post-AI distributions.",
      },
      future: {
        strategies: [
          { title: "Human strengths", items: ["creativity", "empathy", "strategy"] },
          { title: "AI strengths", items: ["speed", "scale", "consistency"] },
          { title: "Safety nets", items: ["UBI", "retraining", "transition funds"] },
        ],
        caption: "The future workplace is a collaboration zone. UBI bridges the gap while humans find new footing.",
        zones: [
          { label: "Human domain" },
          { label: "Collaboration" },
          { label: "AI domain" },
        ],
        ubiLabel: "UBI safety net",
        sr: "Future-of-work landscape shows human, collaboration, and AI domains with UBI as a safety net bridging the transition.",
      },
    },
    algorithmMuse: {
      ariaLabel: "Algorithm as Muse visualization",
      cowrite: {
        chips: [
          { label: "Human", value: "Draft & intent" },
          { label: "AI", value: "Expansion & options" },
          { label: "Result", value: "Co-created text" },
        ],
        caption: "Human sets direction; AI generates variations. Each contribution is visually distinct\u2014for now.",
        canvasHuman: "HUMAN",
        canvasAI: "AI",
        legendHuman: "Human",
        legendAI: "AI",
        sr: "Co-writing interface shows human and AI contributions visually distinguished, collaborating on text.",
      },
      blur: {
        chips: [
          { label: "Originality", value: "Uncertain" },
          { label: "Attribution", value: "Dissolving" },
          { label: "Legal status", value: "Gray area" },
        ],
        caption: "As contributions blend, the line between human and machine authorship fades. Who wrote what?",
        canvasTitle: "AUTHORSHIP FADING",
        canvasDistinct: "Distinct \u2192",
        canvasIndistinct: "\u2192 Indistinguishable",
        sr: "Authorship blur visualization where the boundary between human and AI contributions fades, questioning originality.",
      },
      gallery: {
        chips: [
          { label: "Style A", value: "Converging" },
          { label: "Style B", value: "Converging" },
          { label: "Style C", value: "Converging" },
        ],
        caption: "When millions of creators use the same models, outputs converge. Diversity flattens toward a statistical mean.",
        canvasTitle: "CREATIVE OUTPUTS CONVERGING",
        canvasDiverse: "Diverse \u2192",
        canvasHomog: "\u2192 Homogeneous",
        sr: "Homogeneity gallery showing creative works converging toward similar styles when using the same AI models.",
      },
      balance: {
        sliderLabel: "AI capability vs. human creative control",
        sliderAriaLabel: "Balance between AI capability and human creative control",
        rolePrefix: "Creator\u2019s role: ",
        roleLabels: ["Director", "Lead author", "Collaborator", "Editor", "Curator"],
        dragCaption: "Drag to explore how creative control shifts as AI capability increases.",
        canvasHumanControl: "HUMAN CONTROL",
        canvasAICapability: "AI CAPABILITY",
        sr: "Balance visualization between AI capability and human creative control. Use the slider to explore the creator\u2019s evolving role.",
      },
    },
  },
};
