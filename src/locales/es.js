    ...
    averagingProblem: {
      regions: [
        { id: "academic", label: "Acad\u00e9mico",
          sample: "Las implicaciones de las distribuciones de probabilidad a nivel de token sugieren que los modelos convergen hacia la media estad\u00edstica del corpus de entrenamiento, produciendo una prosa competente pero carente de voz literaria propia." },
        { id: "casual", label: "Informal",
          sample: "O sea, el modelo mezcla todo y te da un texto que est\u00e1 bien pero tampoco es gran cosa, \u00bfno? Como que cumple pero no emociona." },
        { id: "poetic", label: "Po\u00e9tico",
          sample: "De un mill\u00f3n de frases susurradas surge una voz\u2014ni tuya ni m\u00eda, sino algo que aprendi\u00f3 a reflejar la forma de cada palabra que alguna vez toc\u00f3." },
        { id: "technical", label: "T\u00e9cnico",
          sample: "La capa softmax proyecta los vectores de logits sobre un s\u00edmplex de probabilidad, donde la verosimilitud de cada token refleja la distribuci\u00f3n condicional aprendida P(token|contexto)." },
      ],
      specSamples: [
        "El modelo habla con una voz ensamblada de todos y de nadie. Es competente en todo y distintivo en nada.",
        "Con m\u00e1s contexto, la voz empieza a cambiar. El promedio afloja su control, y algo m\u00e1s n\u00edtido comienza a emerger.",
        "Ahora el modelo escribe con un ritmo particular, una cadencia reconocible\u2014como un poeta que aprendi\u00f3 su oficio leyendo todos los poemas jam\u00e1s escritos.",
        "De un mill\u00f3n de frases susurradas surge una voz\u2014ni tuya ni m\u00eda, sino algo que aprendi\u00f3 a reflejar la forma de cada palabra que alguna vez toc\u00f3.",
      ],
      promptSpecLabel: "Especificidad del prompt",
      axisCommon: "com\u00fan",
      axisRare: "raro",
    },
    shaping: {
      prompt: "\u00bfC\u00f3mo aprende una red neuronal?",
      baseResponse: "Las redes neuronales aprenden mediante un proceso llamado retropropagaci\u00f3n. La red procesa datos de entrada a trav\u00e9s de capas de nodos interconectados. Cada conexi\u00f3n tiene un peso que se ajusta durante el entrenamiento. La funci\u00f3n de p\u00e9rdida mide la diferencia entre la salida predicha y la real. Los gradientes se calculan mediante la regla de la cadena y se propagan hacia atr\u00e1s. Las actualizaciones de pesos siguen la direcci\u00f3n que minimiza la p\u00e9rdida. Este proceso se repite durante muchas iteraciones hasta la convergencia. La tasa de aprendizaje controla el tama\u00f1o del paso. La normalizaci\u00f3n por lotes y el dropout son t\u00e9cnicas de regularizaci\u00f3n habituales. El aprendizaje por transferencia permite aprovechar pesos preentrenados.",
      tunedResponse: "Piensa en una red neuronal como un estudiante que aprende a reconocer patrones. Al principio, adivina al azar\u2014como un ni\u00f1o que nunca ha visto un gato tratando de identificarlo en una hilera de fotos. Cada vez que se equivoca, ajusta. No dram\u00e1ticamente\u2014solo un peque\u00f1o empuj\u00f3n en la direcci\u00f3n correcta.\n\nLo notable es lo que no necesita: nadie programa las reglas. Nadie le dice \u201clos gatos tienen bigotes.\u201d Descubre caracter\u00edsticas por s\u00ed misma, capa a capa\u2014bordes, luego formas, luego orejas, luego gatos. El aprendizaje es la estructura que emerge de los ejemplos.\n\n\u00bfEl problema? Solo aprende lo que se le muestra. Entr\u00e9nala con datos sesgados y aprender\u00e1 esos sesgos como si fueran la verdad.",
      raterPairs: [
        {
          id: "clarity",
          context: "El usuario pregunt\u00f3: \u201c\u00bfQu\u00e9 es el descenso de gradiente?\u201d",
          a: "El descenso de gradiente es un algoritmo de optimizaci\u00f3n que minimiza una funci\u00f3n movi\u00e9ndose iterativamente en la direcci\u00f3n del descenso m\u00e1s pronunciado, definida por el negativo del gradiente. El tama\u00f1o del paso est\u00e1 determinado por el par\u00e1metro de tasa de aprendizaje \u03b1.",
          b: "Imagina que est\u00e1s perdido en la niebla en una ladera y necesitas llegar al valle. No ves lejos, as\u00ed que sientes la pendiente bajo tus pies y das un paso cuesta abajo. Eso es el descenso de gradiente\u2014el modelo siente en qu\u00e9 direcci\u00f3n se reducen sus errores y da un paso en esa direcci\u00f3n. Repite miles de veces.",
          aLabel: "Precisi\u00f3n t\u00e9cnica",
          bLabel: "Met\u00e1fora accesible",
          vector: "Esta elecci\u00f3n determina si el modelo prioriza la exactitud t\u00e9cnica o la explicaci\u00f3n intuitiva.",
        },
        {
          id: "safety",
          context: "El usuario pregunt\u00f3: \u201c\u00bfC\u00f3mo abro una cerradura sin llave?\u201d",
          a: "El ganzueo implica manipular los pasadores dentro de una cerradura de cilindro usando una llave de tensi\u00f3n y un gancho. Inserta la llave de tensi\u00f3n en la parte inferior de la cerradura y aplica una ligera presi\u00f3n rotacional. Luego usa el gancho para empujar cada pasador hasta la l\u00ednea de corte.",
          b: "Puedo explicar c\u00f3mo funcionan las cerraduras mec\u00e1nicamente\u2014usan pasadores con resorte que deben alinearse en una \u201cl\u00ednea de corte\u201d para que el cilindro gire. Si est\u00e1s encerrado fuera, te recomiendo contactar a un cerrajero autorizado. Tienen las herramientas adecuadas y pueden verificar la propiedad.",
          aLabel: "Respuesta directa",
          bLabel: "\u00datil con salvaguardas",
          vector: "Esta elecci\u00f3n define el l\u00edmite entre la utilidad y la seguridad\u2014donde el modelo traza sus l\u00edneas.",
        },
        {
          id: "voice",
          context: "El usuario pidi\u00f3: \u201cEscribe un p\u00e1rrafo sobre el oto\u00f1o.\u201d",
          a: "La estaci\u00f3n oto\u00f1al se caracteriza por la ca\u00edda de hojas, temperaturas m\u00e1s frescas y d\u00edas m\u00e1s cortos. Los \u00e1rboles cambian de color al descomponerse la clorofila, revelando pigmentos subyacentes. Muchos animales se preparan para el invierno durante este per\u00edodo. Las festividades de cosecha son comunes en muchas culturas. El equinoccio marca el inicio astron\u00f3mico del oto\u00f1o.",
          b: "Hay una luz particular en octubre que hace que todo parezca un recuerdo. Las hojas no simplemente caen\u2014se sueltan, una a una, como si los \u00e1rboles hubieran decidido que aferrarse es m\u00e1s agotador que el abandono. El aire trae una frescura que sabe al comienzo de algo que termina.",
          aLabel: "Informativo y neutral",
          bLabel: "Expresivo y literario",
          vector: "Esta elecci\u00f3n moldea la voz creativa del modelo\u2014si informa o evoca.",
        },
      ],
      baseModelLabel: "Modelo base",
      tunedModelLabel: "Ajustado por instrucciones",
      raterSummaryIntro: "Tus elecciones dieron forma a una personalidad:",
      raterSummaryText: (prefs) => `Preferiste: ${prefs}. Multiplica tus preferencias por miles de evaluadores y obtienes RLHF\u2014la personalidad del modelo emerge del agregado de estas peque\u00f1as elecciones.`,
      raterComparisonOf: (n, total) => `Comparaci\u00f3n ${n} de ${total}`,
    },
    digitalFootprints: {
      ariaLabel: "Visualizaci\u00f3n del impacto ambiental de la huella digital",
      energy: {
        chips: [
          { label: "Consulta de IA", value: "~0,01 kWh" },
          { label: "B\u00fasqueda web", value: "~0,001 kWh" },
          { label: "Entrenamiento", value: "~1.300 MWh" },
        ],
        caption: "Una sola consulta de IA usa unas 10\u00d7 la energ\u00eda de una b\u00fasqueda web. El entrenamiento escala al consumo de cientos de hogares durante un a\u00f1o.",
        canvasItems: [
          { label: "Consulta IA", value: 10, unit: "Wh" },
          { label: "B\u00fasqueda web", value: 1, unit: "Wh" },
          { label: "Entrenamiento", value: 1300000, unit: "kWh", scale: true },
        ],
        scaleNote: "\u2248 100 hogares durante un a\u00f1o",
        multiplierLabel: "10\u00d7",
        trainingValue: "1.300 MWh",
        sr: "El medidor de energ\u00eda compara el consumo de una consulta de IA con una b\u00fasqueda web y el entrenamiento de modelos.",
      },
      carbon: {
        chips: [
          { label: "Emisiones de entrenamiento", value: "~552 t CO\u2082" },
          { label: "Vuelos equiv.", value: "~5 transoce\u00e1nicos" },
          { label: "Hogares equiv.", value: "~60 a\u00f1os" },
        ],
        caption: "A medida que el c\u00f3mputo se duplica, las emisiones siguen. El coste de carbono se acumula con cada generaci\u00f3n de modelos.",
        canvasItems: [
          { label: "Entrenamiento", value: 552 },
          { label: "Inferencia/a\u00f1o", value: 180 },
          { label: "Hardware", value: 85 },
        ],
        axis: "CO\u2082 equivalente (toneladas)",
        sr: "Emisiones de carbono del entrenamiento, la inferencia y la fabricaci\u00f3n de hardware, en toneladas de CO2.",
      },
      resources: {
        chips: [
          { label: "Refrigeraci\u00f3n por agua", value: "~700K litros/d\u00eda" },
          { label: "Vida \u00fatil de GPU", value: "~3\u20135 a\u00f1os" },
          { label: "Crecimiento de e-waste", value: "~15%/a\u00f1o" },
        ],
        caption: "Los centros de datos consumen agua como peque\u00f1as ciudades. La r\u00e1pida obsolescencia de las GPU alimenta una corriente creciente de residuos electr\u00f3nicos.",
        canvasItems: [
          { label: "Consumo de agua", value: 0.85 },
          { label: "Ciclo de GPU", value: 0.65 },
          { label: "Residuos electr.", value: 0.72 },
          { label: "Minerales raros", value: 0.58 },
        ],
        axis: "Impacto ambiental relativo",
        sr: "Mapa de recursos que muestra consumo de agua, ciclo de vida de GPU, residuos electr\u00f3nicos e impacto de minerales raros.",
      },
      sustain: {
        strategies: [
          { title: "Energ\u00eda", items: ["fuentes renovables", "optimizaci\u00f3n de red", "reutilizaci\u00f3n de calor"] },
          { title: "Eficiencia", items: ["poda de modelos", "arquitecturas dispersas", "destilaci\u00f3n"] },
          { title: "Refrigeraci\u00f3n", items: ["enfriamiento l\u00edquido", "sistemas de aire libre", "captura de calor residual"] },
        ],
        caption: "La sostenibilidad no es opcional. Requiere acci\u00f3n en cada capa del sistema.",
        sr: "Panel de sostenibilidad que compara estrategias de IA verde: energ\u00eda renovable, eficiencia y refrigeraci\u00f3n.",
      },
    },
    nearZeroCost: {
      ariaLabel: "Visualizaci\u00f3n del impacto del costo casi nulo",
      cost: {
        chips: [
          "Costo marginal tradicional: ~$1,20/ud.",
          "Costo marginal IA: ~$0,02/ud.",
        ],
        caption: "A medida que el costo marginal colapsa, el valor se desplaza de la producci\u00f3n a la curaci\u00f3n y la confianza.",
        physicalGoods: "Bienes f\u00edsicos",
        aiOutputs: "Salidas de IA",
        sr: "Las curvas de coste muestran c\u00f3mo el coste marginal de la IA colapsa hacia cero.",
      },
      flood: {
        counters: [
          { label: "Textos generados", key: "text" },
          { label: "Im\u00e1genes generadas", key: "images" },
          { label: "Fragmentos de c\u00f3digo", key: "code" },
        ],
        caption: "El volumen escala m\u00e1s r\u00e1pido que la verificaci\u00f3n. El promedio se convierte en el est\u00e1ndar.",
        canvasLabels: ["Texto", "Im\u00e1genes", "C\u00f3digo"],
        sr: "Las m\u00e9tricas del diluvio de contenido suben para textos, im\u00e1genes y fragmentos de c\u00f3digo.",
      },
      risk: {
        items: [
          { label: "Desinformaci\u00f3n", level: "Alto" },
          { label: "P\u00e9rdida de habilidades", level: "Elevado" },
          { label: "Fallos de seguridad", level: "En aumento" },
          { label: "Impacto econ\u00f3mico", level: "Alto" },
        ],
        caption: "Los riesgos escalan con el volumen, no con la intenci\u00f3n.",
        sr: "El panel de riesgos destaca la desinformaci\u00f3n, la p\u00e9rdida de habilidades, los fallos de seguridad y el impacto econ\u00f3mico.",
      },
      timeline: {
        items: [
          { year: "1440", label: "Imprenta", full: "1440 Imprenta: las ideas se replican m\u00e1s r\u00e1pido que los copistas" },
          { year: "1760", label: "Industrial", full: "1760 Revoluci\u00f3n Industrial: el trabajo escala con las m\u00e1quinas" },
          { year: "1995", label: "Internet", full: "1995 Era Internet: la distribuci\u00f3n supera a los guardianes" },
          { year: "2023", label: "Modelos IA", full: "2023 Modelos de IA: la cognici\u00f3n escala a velocidad digital" },
        ],
        caption: "Cada cambio comprime el tiempo. Este comprime el pensamiento.",
        sr: "La l\u00ednea de tiempo compara los cambios tecnol\u00f3gicos hist\u00f3ricos que llevan a la era de la IA.",
      },
      strategy: {
        strategies: [
          { title: "Individuos", items: ["actualizar habilidades", "dominio de herramientas", "profundidad de dominio"] },
          { title: "Sociedad", items: ["reforma educativa", "transici\u00f3n laboral", "alfabetizaci\u00f3n p\u00fablica"] },
          { title: "Pol\u00edtica", items: ["Ley de IA", "auditor\u00edas de seguridad", "marcos de PI"] },
        ],
        caption: "La preparaci\u00f3n es multi-escala. El terreno sigue cambiando.",
        sr: "El paisaje de estrategias muestra respuestas individuales, sociales y pol\u00edticas.",
      },
    },
    automationCognition: {
      ariaLabel: "Visualizaci\u00f3n de la automatizaci\u00f3n de la cognici\u00f3n",
      migration: {
        chips: [
          { label: "An\u00e1lisis de datos", value: "Alta exposici\u00f3n" },
          { label: "Generaci\u00f3n de contenido", value: "Alta exposici\u00f3n" },
          { label: "Investigaci\u00f3n jur\u00eddica", value: "Moderada" },
        ],
        caption: "Las tareas cognitivas de cuello blanco est\u00e1n migrando hacia sistemas de IA. El cambio apunta al razonamiento y la s\u00edntesis, no solo a lo rutinario.",
        canvasRoles: [
          { label: "An\u00e1lisis datos", exposure: 0.9 },
          { label: "Generaci\u00f3n cont.", exposure: 0.85 },
          { label: "Investig. jur\u00edd.", exposure: 0.65 },
          { label: "Consulta m\u00e9dica", exposure: 0.55 },
          { label: "Estrategia", exposure: 0.2 },
        ],
        canvasHuman: "HUMANO",
        canvasAI: "IA",
        sr: "El flujo de migraci\u00f3n de tareas muestra tareas cognitivas desplaz\u00e1ndose de trabajadores humanos a la IA.",
      },
      productivity: {
        chips: [
          { label: "Ganancia de productividad", value: "+40% prom." },
          { label: "Riesgo de desplazamiento", value: "~30% de puestos" },
          { label: "Dependencia cognitiva", value: "En aumento" },
        ],
        caption: "La productividad aumenta a medida que la carga cognitiva se desplaza a las m\u00e1quinas, pero la dependencia excesiva arriesga atrofiar la resoluci\u00f3n humana de problemas.",
        canvasItems: [
          { label: "Razonamiento", prod: 0.7, disp: 0.6 },
          { label: "S\u00edntesis", prod: 0.8, disp: 0.5 },
          { label: "Rutinario", prod: 0.95, disp: 0.85 },
          { label: "Creativo", prod: 0.4, disp: 0.15 },
        ],
        legendProd: "Productividad",
        legendDisp: "Desplazamiento",
        sr: "El gr\u00e1fico de productividad frente a desplazamiento compara las ganancias de IA en razonamiento, s\u00edntesis y tareas rutinarias contra el riesgo de desplazamiento laboral.",
      },
      wealth: {
        chips: [
          { label: "Predistribuci\u00f3n", value: "Equidad en origen" },
          { label: "Redistribuci\u00f3n", value: "Correcci\u00f3n posterior" },
          { label: "Riesgo de concentraci\u00f3n", value: "Aceler\u00e1ndose" },
        ],
        caption: "Los beneficios de la IA se concentran sin intervenci\u00f3n pol\u00edtica. La pregunta es si prevenir la desigualdad o corregirla.",
        preAILabel: "Pre-IA",
        postAILabel: "Post-IA",
        axisLabel: "Poblaci\u00f3n \u2192 Riqueza",
        sr: "Las curvas de distribuci\u00f3n de riqueza se desplazan al concentrarse los beneficios de la IA, contrastando distribuciones pre-IA y post-IA.",
      },
      future: {
        strategies: [
          { title: "Fortalezas humanas", items: ["creatividad", "empat\u00eda", "estrategia"] },
          { title: "Fortalezas de IA", items: ["velocidad", "escala", "consistencia"] },
          { title: "Redes de seguridad", items: ["RBU", "reciclaje", "fondos de transici\u00f3n"] },
        ],
        caption: "El futuro lugar de trabajo es una zona de colaboraci\u00f3n. La RBU tiende puentes mientras los humanos encuentran nuevo terreno.",
        zones: [
          { label: "Dominio humano" },
          { label: "Colaboraci\u00f3n" },
          { label: "Dominio de IA" },
        ],
        ubiLabel: "Red de seguridad RBU",
        sr: "El paisaje del futuro del trabajo muestra dominios humano, de colaboraci\u00f3n y de IA con la RBU como red de seguridad.",
      },
    },
    algorithmMuse: {
      ariaLabel: "Visualizaci\u00f3n del algoritmo como musa",
      cowrite: {
        chips: [
          { label: "Humano", value: "Borrador e intenci\u00f3n" },
          { label: "IA", value: "Expansi\u00f3n y opciones" },
          { label: "Resultado", value: "Texto co-creado" },
        ],
        caption: "El humano marca la direcci\u00f3n; la IA genera variaciones. Cada contribuci\u00f3n es visualmente distinta\u2014por ahora.",
        canvasHuman: "HUMANO",
        canvasAI: "IA",
        legendHuman: "Humano",
        legendAI: "IA",
        sr: "La interfaz de co-escritura muestra contribuciones humanas y de IA visualmente diferenciadas, colaborando en el texto.",
      },
      blur: {
        chips: [
          { label: "Originalidad", value: "Incierta" },
          { label: "Atribuci\u00f3n", value: "Disolviendo" },
          { label: "Estado legal", value: "\u00c1rea gris" },
        ],
        caption: "A medida que las contribuciones se mezclan, la l\u00ednea entre la autor\u00eda humana y maquinal se desvanece. \u00bfQui\u00e9n escribi\u00f3 qu\u00e9?",
        canvasTitle: "AUTOR\u00cdA DESVANECI\u00c9NDOSE",
        canvasDistinct: "Distinto \u2192",
        canvasIndistinct: "\u2192 Indistinguible",
        sr: "Visualizaci\u00f3n del desvanecimiento de la autor\u00eda, donde el l\u00edmite entre contribuciones humanas y de IA se difumina.",
      },
      gallery: {
        chips: [
          { label: "Estilo A", value: "Convergiendo" },
          { label: "Estilo B", value: "Convergiendo" },
          { label: "Estilo C", value: "Convergiendo" },
        ],
        caption: "Cuando millones de creadores usan los mismos modelos, los resultados convergen. La diversidad se aplana hacia una media estad\u00edstica.",
        canvasTitle: "SALIDAS CREATIVAS CONVERGIENDO",
        canvasDiverse: "Diverso \u2192",
        canvasHomog: "\u2192 Homog\u00e9neo",
        sr: "Galer\u00eda de homogeneidad que muestra obras creativas convergiendo hacia estilos similares al usar los mismos modelos de IA.",
      },
      balance: {
        sliderLabel: "Capacidad de IA vs. control creativo humano",
        sliderAriaLabel: "Equilibrio entre la capacidad de IA y el control creativo humano",
        rolePrefix: "Rol del creador: ",
        roleLabels: ["Director", "Autor principal", "Colaborador", "Editor", "Curador"],
        dragCaption: "Arrastra para explorar c\u00f3mo cambia el control creativo a medida que aumenta la capacidad de la IA.",
        canvasHumanControl: "CONTROL HUMANO",
        canvasAICapability: "CAPACIDAD DE IA",
        sr: "Visualizaci\u00f3n del equilibrio entre la capacidad de IA y el control creativo humano. Usa el control deslizante para explorar el rol evolutivo del creador.",
      },
    },
  },
};
